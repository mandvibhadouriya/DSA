...
public class functionProblems{
    ...
    // public static void printSumOfAllOdd(int n){
    //     int temp = 1;
    //     for (int i=2;i<=n;i++){
    //         if(i%2!=0){
    //             temp = temp + i;
    ...
    // public static void calculateCircumferenceOfCircle(double r){
    //     double circumference = 2*Math.PI*r;
    //     System.out.println("Circumference of Circle is : " + circumference);
    // }

    // Write a function that takes in age as input and returns if that person is eligible to vote or not. A person of age > 18 is eligible to vote.
        // public static void printEligibilityToVote(int age){
        //     if(age >= 18){
        ...
        //     do{
        //         System.out.println("This is an Infinite Loop using Do While. Press Ctrl+C to exit..");
        //     }while(true);
        // }
